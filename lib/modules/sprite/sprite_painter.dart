...
class SpritePaint extends StatefulWidget {
  const SpritePaint({super.key});

  @override
  State<SpritePaint> createState() => _SpritePaintState();
}

class _SpritePaintState extends State<SpritePaint> with TickerProviderStateMixin {
  late Ticker ticker;
  ...
  void initState() {
    super.initState();
    ticker = Ticker(_tick);
    rootBundle.load('assets/images/sprites.png')
